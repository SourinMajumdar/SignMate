...
const BULLETS = [
  {
    icon: Zap,
    label: "Live Preview",
    desc: "See every change reflected instantly as you type.",
  },
  {
    icon: Layers,
    label: "Multiple Templates",
    desc: "5 professional layouts for any style or brand.",
  },
  {
    icon: Palette,
    label: "Brand Color Customization",
    desc: "Pick any color to perfectly match your identity.",
  },
  {
    icon: Code2,
    label: "One-Click HTML Export",
    desc: "Clean HTML you can paste directly into Gmail or Outlook.",
  },
];
          ...
          <div className="space-y-8">
            {BULLETS.map(({ icon: Icon, label, desc }, i) => (
              ...
              >
                ...
                <div>
                <p className="font-semibold text-text-base text-lg">{label}</p>
            ...
            <div className="bg-bg-base rounded-2xl border border-border-base overflow-hidden shadow-sm">
              ...
              <div className="p-5 grid grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-xs text-text-muted font-semibold block mb-1">
                      Full Name
                    </label>
